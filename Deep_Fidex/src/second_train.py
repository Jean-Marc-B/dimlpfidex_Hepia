...
def train_second_model(cfg, X_train, Y_train, X_test, Y_test, intermediate_model, args):
    ...
    if args.statistic == "HOG": # If we don't add the original image
    ...
    elif args.statistic in ["probability", "probability_and_image", "probability_multi_nets", "probability_multi_nets_and_image", "probability_multi_nets_and_image_in_one", "LBP_and_image", "DCT_and_image", "HOG_and_image", "stats_and_image"]:   # We create an image out of the probabilities(or stats) (for each class) of cropped areas of the original image
        ...
        if cfg["second_model"] == "cnn":
            ...
            if args.statistic in ["probability_and_image", "probability_multi_nets", "probability_multi_nets_and_image", "probability_multi_nets_and_image_in_one", "LBP_and_image", "DCT_and_image", "HOG_and_image", "stats_and_image"]:
                nb_chanels_stats = cfg["nb_classes"]
                if args.statistic in ["LBP_and_image", "DCT_and_image", "HOG_and_image", "stats_and_image"]:
            ...
            elif args.statistic in ["probability_and_image", "LBP_and_image", "DCT_and_image", "HOG_and_image", "stats_and_image"]: #Train with VGG for image and CNN for probas, stats or HOG
