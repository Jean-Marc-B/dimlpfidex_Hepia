...
nb_quant_levels = 100
hiknot = 5
weights_outfile = "afterBatch/weights32.wts"
nb_channels = 6
segment_size = 250
nb_attributes = nb_channels*segment_size
nb_classes = 8
nb_epochs = 80
model_checkpoint_weights = "afterBatch/weightsModel32.keras"
stats_file = "afterBatch/stats32.txt"
train_valid_pred_outfile = "afterBatch/predTrain32.out"
test_pred_outfile = "afterBatch/predTest32.out"
train_data_file = "trainData.txt"
train_class_file = "trainClass.txt"
test_data_file = "testData.txt"
test_class_file = "testClass.txt"
train_data_file_cnn = "afterBatch/trainDataCNN.txt"
test_data_file_cnn = "afterBatch/testDataCNN.txt"
...
model.add(BatchNormalization(name='last_batch_norm'))
...
print(train_valid_features.shape)
