...
int fidexGlo(const std::string &command) {
  try {
    ...
    static const std::vector<ParameterCode> validParams = {TEST_DATA_FILE, GLOBAL_RULES_FILE, NB_ATTRIBUTES, NB_CLASSES, ROOT_FOLDER, ATTRIBUTES_FILE,
                                                           ...
                                                           MAX_FAILED_ATTEMPTS, ALLOW_NO_FID_CHANGE, FIDELITY_IMPORTANCE, THRESHOLD_FIDELITY_ONLY, MIN_FIDELITY, NB_FIDEX_RULES, LOWEST_MIN_FIDELITY, DROPOUT_DIM, DROPOUT_HYP, NB_QUANT_LEVELS,
